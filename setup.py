...
setup(
    name='ontology-py-sdk',
    version='0.2.2',
    description="A Python RPC Client for the ONT Blockchain",
    long_description=readme,
    author="Thomas Saunders",
    author_email='tom@cityofzion.io',
    url='https://github.com/Yihen/ontology-py-sdk',
    packages=find_packages(include=['rpc']),
    include_package_data=True,
    install_requires=requirements,
    license="MIT license",
    zip_safe=False,
    keywords='ont, python, rpc, client',
    classifiers=[
